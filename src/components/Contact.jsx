    ...
    <>
      <section id="contact" className="contact container section">
        ...
        <p className="about__description">
          ...
          itaque iusto dolores deleniti ut tempora!
        </p>
        <button className="contact__btn btn">
          <a href="mailto:vanlalgeorgevpz@gmail.com">Email me</a>
        </button>
      </section>

      {/* ///////// SOCIAL ////////// */}

      <section className="social container section">
        <a href="https://www.facebook.com/vanlalgeorge.sp/" target="_blank">
          <svg
            viewBox="0 0 24 24"
            fill="none"
        ...
        <a href="https://www.instagram.com/ge_or_geee" target="_blank">
          <svg
            width="64px"
            height="64px"
            viewBox="0 -0.5 25 25"
        ...
        <a href="https://twitter.com/zeorse" target="_blank">
          <svg
            xmlns="http://www.w3.org/2000/svg"
            x="0px"
            y="0px"
        ...
        <a href="https://wa.link/8yrmrj" target="_blank">
          <svg
            width="64px"
            height="64px"
            viewBox="0 0 24 24"
